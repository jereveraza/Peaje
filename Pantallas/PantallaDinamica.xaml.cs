...
{
    /// <summary>
    /// Lógica de interacción para PantallaDinamica.xaml
    /// </summary>
    public partial class PantallaDinamica : Window, IPantalla
    {
        ...
        public NameValueCollection sectorTeclas { set; get; }
        ...
        public ISubVentana VentanaAuxiliar { set; get; }
        ...
        public PantallaDinamica(VentanaPrincipal principal)
        {
            InitializeComponent();
        ...
        {
            FrameworkElement control = (FrameworkElement)borderDinamica.Child;
            borderDinamica.Child = null;
            Close();
            return control;
        }
